...
func provideRouter(healthHandler *handlers.HealthHandler, userHandler *handlers.UserHandler, limen *limen.Limen) *chi.Mux {
	r := chi.NewRouter()
	...
	r.Group(func(r chi.Router) {
		...
		r.Delete("/auth/users/me", userHandler.DeleteSelf)
	})
