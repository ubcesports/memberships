          ...
          <tbody>
            {logs.map((log) => (
              <tr key={log.request_id} className="border-b border-brand-border/70 last:border-b-0">
                ...
                <td className="whitespace-nowrap px-4 py-3 text-brand-text-muted">{log.action}</td>
                <td className="whitespace-nowrap px-4 py-3 text-brand-text-muted">
                  {log.description}
                </td>
                <td className="whitespace-nowrap px-4 py-3 text-brand-text-muted">{log.outcome}</td>
